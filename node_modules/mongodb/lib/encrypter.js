...
const AutoEncrypter = mongodbClientEncryption.extension(require('mongodb')).AutoEncrypter;
...
class Encrypter {
   ...
   * @param {{autoEncryption: import('mongodb/lib/mongo_client').AutoEncryptionOptions, bson: object}} options
   */
